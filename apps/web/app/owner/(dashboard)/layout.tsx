...
// Owner and admin currently see the exact same dashboard — the role still
// exists (and is still checked server-side on every page/route) so a future
// feature can be restricted to admin again without another migration.
const NAV = [
